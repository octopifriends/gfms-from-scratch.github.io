...
```{python tangle="../geogfm/__init__.py"}
# geogfm package init
```

```{python tangle="../geogfm/core/__init__.py"}
# geogfm.core
```

```{python tangle="../geogfm/data/__init__.py"}
# geogfm.data
```

```{python tangle="../geogfm/data/datasets/__init__.py"}
# geogfm.data.datasets
```

```{python tangle="../geogfm/data/transforms/__init__.py"}
# geogfm.data.transforms
```

### 1) Typed Configs

```{python tangle="../geogfm/core/config.py"}
...
```{python tangle="../geogfm/data/transforms/normalization.py"}
from __future__ import annotations
import numpy as np
...
### 3) Patchify Utilities

```{python tangle="../geogfm/data/transforms/patchify.py"}
from __future__ import annotations
import numpy as np
...
### 4) Minimal STAC-like Dataset

```{python tangle="../geogfm/data/datasets/stac_dataset.py"}
from __future__ import annotations
...
```{python tangle="../geogfm/data/loaders.py"}
from __future__ import annotations
from typing import Tuple
