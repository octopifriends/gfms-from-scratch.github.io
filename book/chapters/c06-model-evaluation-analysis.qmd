...
```{python}
#| tangle: geogfm/evaluation/__init__.py
#| header: "geogfm.evaluation — package init (Week 6). Evaluation utilities: visualization and metrics."
# geogfm.evaluation
```
...
```{python}
#| tangle: geogfm/evaluation/visualization.py
#| header: "geogfm.evaluation.visualization — Reconstruction visualization utilities (Week 6)."
...
```{python}
#| tangle: geogfm/evaluation/metrics.py
#| header: "geogfm.evaluation.metrics — Simple metrics like PSNR for reconstructions (Week 6)."
from __future__ import annotations
import torch
