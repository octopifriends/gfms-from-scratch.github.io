...
### 2) Positional Encoding (Sinusoidal) → `geogfm/modules/embeddings/positional_encoding.py`

```{python}
#| tangle: geogfm/modules/embeddings/positional_encoding.py
...
### 3) Multihead Self-Attention → `geogfm/modules/attention/multihead_attention.py`

```{python}
#| tangle: geogfm/modules/attention/multihead_attention.py
...
### 4) MLP and Transformer Block (PreNorm) → `geogfm/modules/blocks/`

```{python}
#| tangle: geogfm/modules/blocks/mlp.py
...
```{python}
#| tangle: geogfm/modules/blocks/transformer_block.py
