...
## Minimal Setup (Section 3 Only)

If you only want to run **Section 3** (Understanding STAC APIs), here's the minimal import:

```{python}
# Core imports for Section 3: STAC APIs
import logging
from pystac_client import Client
import planetary_computer as pc

# Import authentication helper from Week 1 module
from geogfm.c01 import setup_planetary_computer_auth
...
logger.info(f"Authentication status: {'Authenticated' if auth_status else 'Anonymous'}")

print("✅ Ready to run Section 3!")
```
