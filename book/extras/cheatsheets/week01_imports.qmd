...
If you get an error like `fatal: refusing to merge unrelated histories`, this means Git thinks your fork and the upstream repo don't share a common history. Here's how to fix it:
...
# Git will open an editor for a merge commit message
...
#### Option 2: Rebase Your Fork (Advanced)

If you haven't made significant changes and want a clean history:
...
# Push to your fork (requires force push)
...
:::{.callout-warning}
### ⚠️ Important: Force Push Safety

Only use `git push --force` on **your fork's main branch** if:
1. You've backed up your work (stash or feature branch)
2. You understand this will overwrite your fork's history
3. You're not collaborating with others on your fork
:::
